...
def create_query(user_query, click_prior_query, filters, sort="_score",
                 sortDir="desc", size=10, source=None, synonyms=False):
    name_field = "name"
    if synonyms:
                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": ["name^10", "name.synonyms^10", "name.hyphens^10", "shortDescription^5",
